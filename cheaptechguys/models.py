...
class Product(models.Model):
    ...
    author = models.ForeignKey(User, on_delete=models.CASCADE, null=True, default='Del')
    likes = models.ManyToManyField(User, related_name='likes', null=True, default='Del')
